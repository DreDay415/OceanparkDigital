  ...
  const services = [
    {
      ...
      description: "We optimize your website to rank higher for the keywords your clients are actively searching for, driving organic growth.",
      icon: Search
    },
    {
        ...
        <div className="container mx-auto px-4">
          <div className="inner-header flex h-[65vh] items-center justify-center">
            <div className="max-w-3xl mx-auto text-center text-white">
              <svg 
                version="1.1" 
                className="w-[50px] h-[50px] inline-block align-middle mr-4 fill-white"
                baseProfile="tiny" 
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 500 500"
              >
                <path d="M250.4,0.8C112.7,0.8,1,112.4,1,250.2c0,137.7,111.7,249.4,249.4,249.4c137.7,0,249.4-111.7,249.4-249.4
              ...
              <h1 className="text-5xl font-light mb-6 inline-block align-middle">
                Ocean Park Digital
              </h1>
              <p className="text-xl mb-8 text-white/90">
                We execute creative solutions to help business owners thrive in the digital space.
              </p>
              <a
